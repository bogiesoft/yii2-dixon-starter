...
namespace account\modules\app\controllers;

use Yii;
use account\modules\app\models\OauthClients;
use account\modules\app\models\OauthClientsSearch;
...
class OauthClientsController extends Controller
{
    ...
    {
        if (($model = OauthClients::find()->byUserID()->where(['client_id'=>$id])->one()) !== null) {
            return $model;
        } else {
